...
%         disp (best);
        ...
        m1 = readfis('BaseRobotFA.fis');
        
        subplot(5,1,1); plotmf(m1,'input',1);
        subplot(5,1,2); plotmf(m1,'input',2);
        subplot(5,1,3); plotmf(m1,'output',1);
        subplot(5,1,4); plotmf(m1,'output',1);
